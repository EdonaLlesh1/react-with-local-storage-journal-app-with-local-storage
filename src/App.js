...
function App() {
  const [entries, setEntries] = useLocalStorageState("journal-entries", initialEntries);
  const [filter, setFilter] = useLocalStorageState("journal-filter", "all"); // "all" or "favorites"
